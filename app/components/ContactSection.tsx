				...
				>
					...
					<div className="relative z-10">
						<motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
							<h2 style={{marginBottom: '32px'}} className="text-4xl font-bold mb-3 text-center bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 text-transparent bg-clip-text">
								Contact
							</h2>
						...
						<div id="contact links" className="flex flex-col items-center gap-6 mb-8">
							<motion.a
								href="mailto:giannisiliadis2k15@gmail.com"
						...
						<div id="github and linked in" className="flex flex-wrap justify-center gap-6">
							<motion.a
								href="https://github.com/John-Iliadis"
								target="_blank"
							...
							<motion.a
								href="https://www.linkedin.com/in/john-iliadis/"
								target="_blank"
								rel="noopener noreferrer"
								whileHover={{ scale: 1.05 }}
								whileTap={{ scale: 0.95 }}
